...
jQuery(function() {
	...
	$("ul#category_switch li > a").click(function(e) {
		...
		// adding position of the mouse when it's clicked and count of circles on the map
		var circleCount = $('circle').length;
		var xPos = e.pageX;
        var yPos = e.pageY;
       
        alert('x: ' + xPos + ' y: ' + yPos + ' circleCount: ' +circleCount);
